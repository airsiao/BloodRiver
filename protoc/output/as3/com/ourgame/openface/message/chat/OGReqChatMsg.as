package com.ourgame.openface.message.chat {
	...
	import com.ourgame.openface.message.chat.OGReqChatMsg.MsgType;
	...
	public dynamic final class OGReqChatMsg extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.ourgame.openface.message.chat.OGReqChatMsg.Type", "type", (1 << 3) | com.netease.protobuf.WireType.VARINT, com.ourgame.openface.message.chat.OGReqChatMsg.MsgType);
		 ...
		 *  @private
		 */
		public static const ROLENAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.ourgame.openface.message.chat.OGReqChatMsg.RoleName", "roleName", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const SHOWNAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.ourgame.openface.message.chat.OGReqChatMsg.ShowName", "showName", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const MSG:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.ourgame.openface.message.chat.OGReqChatMsg.Msg", "msg", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const VOICEID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.ourgame.openface.message.chat.OGReqChatMsg.VoiceID", "voiceID", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TIME:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("com.ourgame.openface.message.chat.OGReqChatMsg.Time", "time", (6 << 3) | com.netease.protobuf.WireType.VARINT);
