package com.ourgame.mahjong.bloodriver.protoc.message {
	...
	public dynamic final class NtfCastDice extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const SEAT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.ourgame.mahjong.bloodriver.protoc.message.NtfCastDice.seat", "seat", (1 << 3) | com.netease.protobuf.WireType.VARINT);
