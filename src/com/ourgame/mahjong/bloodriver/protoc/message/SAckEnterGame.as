package com.ourgame.mahjong.bloodriver.protoc.message {
	...
	public dynamic final class SAckEnterGame extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GAMEID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("com.ourgame.mahjong.bloodriver.protoc.message.SAckEnterGame.gameId", "gameId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const RESULT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.ourgame.mahjong.bloodriver.protoc.message.SAckEnterGame.result", "result", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAILREASON:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.ourgame.mahjong.bloodriver.protoc.message.SAckEnterGame.failReason", "failReason", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
