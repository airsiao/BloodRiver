package com.ourgame.mahjong.bloodriver.protoc.message {
	...
	public dynamic final class CReqUserTrust extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GAMEID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("com.ourgame.mahjong.bloodriver.protoc.message.CReqUserTrust.gameId", "gameId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TRUST:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.ourgame.mahjong.bloodriver.protoc.message.CReqUserTrust.trust", "trust", (2 << 3) | com.netease.protobuf.WireType.VARINT);
