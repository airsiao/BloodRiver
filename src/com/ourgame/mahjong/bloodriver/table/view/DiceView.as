package com.ourgame.mahjong.bloodriver.table.view
{
	...
	public class DiceView extends View
	{
		...
		override public function onAdd():void
		{
			...
			TableLayer.instance.foreground.addChild(this.dealMotion);
			...
			TableLayer.instance.foreground.addChild(this.swapMotion);
			
			this.dice = AssetsManager.instance.getDefinitionMovieClip(UITableDefinition.Dice);
			this.dice.visible = false;
			TableLayer.instance.foreground.addChild(this.dice);
		}
		...
		override public function onRemove():void
		{
			...
			TableLayer.instance.foreground.removeChild(this.dice);
			this.dice = null;
			
			TableLayer.instance.foreground.removeChild(this.dealMotion);
			this.dealMotion = null;
			
			TableLayer.instance.foreground.removeChild(this.swapMotion);
