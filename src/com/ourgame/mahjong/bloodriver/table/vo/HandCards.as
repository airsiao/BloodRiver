package com.ourgame.mahjong.bloodriver.table.vo
{
	...
	import com.ourgame.mahjong.bloodriver.table.enum.FanType;
	...
	public class HandCards
	{
		...
		public function clone():HandCards
		{
			return new HandCards(new CardList(this.cards.list.concat()), new GroupList(this.groups.list.concat()));
		}
