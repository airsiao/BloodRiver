package com.ourgame.mahjong.bloodriver.enum
{
	 ...
	 * @author SiaoLeon
	 */
	public class UIEffectDefinition
	{
		
		/**
		 * 基础值
		 */
		private static const BASE:String = "com.ourgame.mahjong.bloodriver.resource.effect.";
		
		/**
		 * 碰
		 */
		public static const Peng:String = BASE + "Peng";
		
		/**
		 * 杠
		 */
		public static const Gang:String = BASE + "Gang";
		
		/**
		 * 胡
		 */
		public static const Hu:String = BASE + "Hu";
